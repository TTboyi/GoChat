// ============================================================
// 文件：back/internal/service/admin_service.go
// 作用：管理后台相关业务逻辑：查询所有用户/群聊、封禁用户、系统统计数据。
//
// 管理员功能：
//   GetAllUsers    - 查询所有用户列表（含已封禁用户），供管理员审查
//   BanUser        - 设置用户 status=1（封禁），封禁用户无法登录
//   GetAllGroups   - 查询所有群聊列表，供管理员监控
//   AdminDismissGroup - 强制解散群聊（无需是群主，是管理员权力）
//   GetSystemStats - 统计总用户数、总群数、总消息数
//   GetDailyStats  - 按天统计新增用户和消息量（用于数据可视化图表）
// ============================================================
package service
